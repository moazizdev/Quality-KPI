...
const translations = {
  ...
  'License expires in': { en: 'License expires in', ar: 'الترخيص ينتهي بعد' },
  'days': { en: 'days', ar: 'أيام' },
  'no expiry': { en: 'no expiry', ar: 'بدون انتهاء' },
  'Activated': { en: 'Activated', ar: 'مفعل' },
  'Expires': { en: 'Expires', ar: 'ينتهي' },
  'Days remaining': { en: 'Days remaining', ar: 'الأيام المتبقية' },
  'Failed to load license info': { en: 'Failed to load license info', ar: 'فشل تحميل معلومات الترخيص' },
